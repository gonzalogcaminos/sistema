                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="apellido" class="form-control" placeholder="Puto Apellido de la persona">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Mail</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="mail" class="form-control" placeholder="Mail">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Area</label>
                                    <div class="col-md-9">
                                        <input type="area" v-model="area" class="form-control" placeholder="Area">
                                    </div>
                                </div>
                                <div class="form-group row">
